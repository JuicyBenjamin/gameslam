...
ALTER TABLE "slam_comments" ADD CONSTRAINT "slam_comments_slam_entry_id_slam_entries_id_fk" FOREIGN KEY ("slam_entry_id") REFERENCES "public"."slam_entries"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "slam_ratings" ADD CONSTRAINT "slam_ratings_slam_entry_id_slam_entries_id_fk" FOREIGN KEY ("slam_entry_id") REFERENCES "public"."slam_entries"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "slams" ADD CONSTRAINT "slams_created_by_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
